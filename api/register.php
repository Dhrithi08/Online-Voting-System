...
if ($password1 == $cpassword1)//check password and cpassword match
	...
	try {
		$insert = mysqli_query($connect, "INSERT INTO user (name,aadhar_no,password,address,photo,role,status,votes) VALUES('$name1','$mobile1','$password1','$address1','$image1','$role1',0,0)");
		if ($insert) {
			echo "
                <script>
